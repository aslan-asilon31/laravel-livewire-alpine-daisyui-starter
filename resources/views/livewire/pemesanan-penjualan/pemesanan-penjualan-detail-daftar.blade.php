<div>
  ...
  <x-button label="Tambah Detail Pemesanan Penjualan Detail" class="btn-sm btn-success text-white" wire:click="buat" />
  ...
  <x-modal wire:model="modalDetail" title="Pemesanan Penjualan Detail" class="backdrop-blur" without-trap-focus>
