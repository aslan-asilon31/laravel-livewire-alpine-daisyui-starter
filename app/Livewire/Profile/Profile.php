...
use App\Livewire\Profile\Forms\ProfileForm;
...
class Profile extends Component
{
  ...
  #[\Livewire\Attributes\Locked]
  protected $masterModel = \App\Models\MsPegawaiAkun::class;

  #[\Livewire\Attributes\Locked]
  public array $optionStatus = [];

  public ProfileForm $masterForm;
  ...
  public function buat()
  {
    ...
    $masterData = $this->masterModel::findOrFail(\Illuminate\Support\Facades\Auth::guard('pegawai')->user()->id);
    $this->masterForm->nama = $masterData->msPegawai->nama;
    $this->masterForm->email = $masterData->msPegawai->email;
    $this->masterForm->no_telepon = $masterData->msPegawai->no_telepon;
