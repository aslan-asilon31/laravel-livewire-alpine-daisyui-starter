...
use App\Livewire\Admin\Contents\ProductContentResources\Forms\ProductContentQnaForm;
...
class ProductContentQnaCrud extends Component
{
  ...
  {
    return view('livewire.pages.admin.product-content-resources.product-content-qna-crud')
      ->title($this->title);
  }
