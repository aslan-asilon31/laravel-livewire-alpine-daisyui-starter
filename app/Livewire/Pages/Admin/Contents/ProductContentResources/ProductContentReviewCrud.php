...
use App\Livewire\Admin\Contents\ProductContentResources\Forms\ProductContentReviewForm;
...
class ProductContentReviewCrud extends Component
{
  ...
  {
    return view('livewire.pages.admin.product-content-resources.product-content-review-crud')
      ->title($this->title);
  }
