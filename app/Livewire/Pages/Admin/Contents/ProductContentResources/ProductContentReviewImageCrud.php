...
use App\Livewire\Admin\Contents\ProductContentResources\Forms\ProductContentReviewImageForm;
...
class ProductContentReviewImageCrud extends Component
{
  ...
  {
    return view('livewire.pages.admin.product-content-resources.product-content-review-image-crud')
      ->title($this->title);
  }
