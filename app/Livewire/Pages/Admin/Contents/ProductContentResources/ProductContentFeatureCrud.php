...
use App\Livewire\Admin\Contents\ProductContentResources\Forms\ProductContentFeatureForm;
...
class ProductContentFeatureCrud extends Component
{
  ...
  {
    return view('livewire.pages.admin.product-content-resources.product-content-feature-crud')
      ->title($this->title);
  }
