...
class HakAksesSeeder extends Seeder
{
    public function run()
    {
        $halamanData = [
            ...
            ['nama' => 'ms_tr_pesanan_penjualan-daftar'],
            ['nama' => 'ms_tr_pesanan_penjualan-buat'],
            ['nama' => 'ms_tr_pesanan_penjualan-edit'],
            ['nama' => 'ms_tr_pesanan_penjualan-update'],
            ['nama' => 'ms_tr_pesanan_penjualan-simpan'],
            ['nama' => 'ms_tr_pesanan_penjualan-hapus'],
            ['nama' => 'ms_tr_pesanan_penjualan-lihat'],
        ...
        foreach ($halamanData as $data) {
            DB::table('hak_akses')->insert([
                ...
                'nama' => $data['nama'],
                'nomor' => \App\Models\HakAkses::max('nomor') ?? 0,
                'dibuat_oleh' => 'admin',
                'diupdate_oleh' => 'admin',
